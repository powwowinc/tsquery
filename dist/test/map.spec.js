...
// console.log('baz');
            ...
            `.trim());
            const result = map(tree, 'Identifier[name="console"]', () => factory.createIdentifier('logger'));
...
// console.log('baz');
            ...
            `.trim());
            const resultOne = map(tree, 'Identifier[name="console"]', () => factory.createIdentifier('logger'));
            const resultTwo = map(resultOne, 'Identifier[name="logger"]', () => factory.createIdentifier('log'));
...
// console.log('baz');
            ...
            `.trim());
            const result = map(tree, 'Identifier[name="console"]', () => factory.createPropertyAccessExpression(factory.createThis(), 'logger'));
            expect(print(result)).toEqual(`
